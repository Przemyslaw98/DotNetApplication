    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Wyślij ponownie e-mail weryfikacyjny");

                    ViewBag.errorMessage = "Konto niezweryfikowane. Sprawdź pocztę e-mail.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Zweryfikuj e-mail");


                    ViewBag.Message = "Rejestracja przebiegła pomyślnie. E-mail werifikacyjny został wysłany.";
        ...
        private async Task<string> SendEmailConfirmationTokenAsync(string userID, string subject)
        {
            ...
            await UserManager.SendEmailAsync(userID,
                       "Zweryfikuj e-mail", "Aby potwierdzić adres e-mail kliknij <a href=\""
                       + callbackUrl + "\">tutaj</a>");
